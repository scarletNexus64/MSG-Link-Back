...
Route::prefix('v1')->group(function () {
    ...
    // ==================== PUBLIC CONFESSIONS FEED (auth optionnelle pour Premium Pass) ====================
    // Note: Ces routes utilisent OptionalAuth pour permettre l'accès public tout en authentifiant les utilisateurs connectés
    ...
    Route::post('/account-deletion-request/{requestId}/cancel', [AccountDeletionController::class, 'cancel']);
    Route::post('/account-deletion-request/{requestId}/status', [AccountDeletionController::class, 'status']);
